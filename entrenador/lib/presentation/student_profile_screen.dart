                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoRow('Nombre Completo', widget.usuarioSeleccionado.userName),
                        const SizedBox(height: 40),
                        
                        _buildSectionTitle('Email'),
                        _buildInfoRow('Email', widget.usuarioSeleccionado.getEmail()),
                        const SizedBox(height: 40),

                        _buildSectionTitle('Edad'),
                        _buildInfoRow('Edad', widget.usuarioSeleccionado.getAge()),
                        const SizedBox(height: 40),

                        _buildSectionTitle('Información de Entrenamiento'),
